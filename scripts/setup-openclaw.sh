...
PORT="${OPENCLAW_GATEWAY_PORT:-18791}"
...
openclaw --profile "$PROFILE" config set agents.defaults.skills '["nasa-apod"]' --strict-json >/dev/null
...
echo "OpenClaw profile '$PROFILE' is restricted to the nasa-apod skill"
